...
sudo pacman -S recoll vlc smplayer freemind filezilla gimp gimp-nufraw geeqie libreoffice libreoffice-fresh-ru kdenlive audacity screenfetch transmission-gtk galculator klavaro calibre solaar bash-completion gnome-keyring seahorse mc breeze-gtk --noconfirm
